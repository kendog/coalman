...
def files_delete(id):
    ...
    @files_bp.route('/admin/files/add', methods=['POST', 'GET'])
    @login_required
    def admin_files_add():
        if 'submit-add' in request.form:
            # Update Metadata
    ...
    @files_bp.route('/admin/files/edit/<id>', methods=['POST', 'GET'])
    @login_required
    ...
    @files_bp.route('/admin/files/delete/<id>', methods=['POST', 'GET'])
    @login_required
